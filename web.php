...
use App\Http\Controllers\SellExchangeController;
...
Route::middleware(['setData'])->group(function () {
    ...
    Auth::routes();
    Route::get('/telegram/daily-report', [\App\Http\Controllers\CashRegisterController::class, 'sendDailyReportToTelegram']);
...
Route::middleware(['setData', 'web', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('sale_pos/get-product-last-purchase', [SellPosController::class, 'getProductLastPurchase']);
    ...
    Route::get('/home/top-customers', [HomeController::class, 'getTopCustomers']);
    Route::get('/home/top-products', [HomeController::class, 'getTopProducts']);
    ...
    Route::get('/sell-products/list', [ProductController::class, 'getSellProducts']);


    Route::get('/products/premade/get_product_row/{variation_id}', [ProductController::class, 'getPremadeProductRaw']);
    ...
    // New
    Route::get('/products/get_others_units', [ProductController::class, 'getOthersUnits']);
    // New
    ...
    // New
    Route::get('/products/search/barcode', [ProductController::class, 'getProductsByBarcode']);
    // New

    Route::get('/products/search/barcode/time', [ProductController::class, 'getProductsByBarcodeTime']);
    ...
    Route::post('/purchases/get_exchange_recived_entry_row', [PurchaseController::class, 'getExchangeRecivedEntryRow']);



    Route::post('/purchases/check_ref_number', [PurchaseController::class, 'checkRefNumber']);
    Route::get('/purchases/list', [PurchaseController::class, 'getPurchasesList']);
    ...
    Route::get('/sells/pos/get_sell_product_row/{variation_id}/{transaction_id}', [SellPosController::class, 'getSellProductRow']);
    ...
    Route::get('/labels/show/qrcode', [LabelsController::class, 'showQrcode']);
    ...
    Route::get('/labels/preview/qr', [LabelsController::class, 'previewQr']);
    // Check the second part of this array
    Route::post('/payments/receive', [TransactionPaymentController::class, 'PaymentRecived']);
    Route::post('/payments/receive', [TransactionPaymentController::class, 'addPayment']);
    // Correct
    Route::get('/payments/receive', [TransactionPaymentController::class, 'paymentReceived'])->name('payments.receive');
    //Reports...
    ...
    Route::get('/reports/stock-history-report', [ReportController::class, 'stockHistoryReport']);
    ...
    Route::get('/reports/item-wise-sell-report', [ReportController::class, 'itemWiseSalesReport']);
    Route::get('/reports/z-purchase-payment-report', [ReportController::class, 'zPurchasePaymentReport']);
    Route::get('/reports/daily/summary', [ReportController::class, 'dailySummaryReport']);
    Route::get('/reports/daily/purchase', [ReportController::class, 'dailyPurchaseReport']);
    Route::get('/reports/daily/purchase/return', [ReportController::class, 'dailyPurchaseReturnReport']);
    Route::get('/reports/daily/purchase/payment', [ReportController::class, 'dailyPurchasePaymentReport']);
    Route::get('/reports/daily/sales', [ReportController::class, 'dailySaleReport']);
    Route::get('/reports/daily/sales/return', [ReportController::class, 'dailySaleReturnReport']);
    Route::get('/reports/daily/customer-payment', [ReportController::class, 'dailyCustomerPaymentReport']);
    Route::get('/reports/daily', [ReportController::class, 'getDailyReport']);
    Route::get('report/get/contact-balance', [ReportController::class, 'getContactBalance']);

    Route::get('/reports/serial-report', [ReportController::class, 'getSerialReport']);
    ...
    // New For Payment Recived
    Route::get('/payments/pay-contact-due-form/{contact_id}', [TransactionPaymentController::class, 'getPayContactDueForm']);
    Route::get('/payments/recive', [TransactionPaymentController::class, 'PaymentRecived']);
    Route::post('/payments/pay-contact-due/form', [TransactionPaymentController::class, 'postPayContactDueForm']);
    Route::get('/all/payments/{contact_id}', [TransactionPaymentController::class, 'getAllPayments']);

    Route::get('/print-voucher/{id}', [TransactionPaymentController::class, 'PrintVoucher'])->name('print.voucher');

    // Route::get('/view/payment/voucher/{id}', [TransactionPaymentController::class, 'PrintVoucher'])->name('print.voucher');
    // New For Payment Recived
    ...
    Route::get('validate-invoice-to-exchange/{invoice_no}', [SellReturnController::class, 'validateInvoiceToExchange']);
    ...
    Route::delete('/sell-return/deletemain/{id}', [SellReturnController::class, 'destroyMain']);
    Route::get('/sell-return/printmain/{id}', [SellReturnController::class, 'printInvoiceMain']);

    
    Route::get('/return/list', [SellReturnController::class, 'addsellReturnList']);
    Route::get('/sell-return/add/{id}', [SellReturnController::class, 'add']);
    Route::post('sell-return/add/post', [SellReturnController::class, 'storeAdd']);
    Route::get('/sell-return/showmain/{id}', [SellReturnController::class, 'showmain']);

     // sell exchange 
    Route::resource('sell-exchange', SellExchangeController::class);
   Route::get('sell-exchange/{id}', 'SellExchangeController@show')->name('sell-exchange.show');

    Route::get('/sell-exchange/create-exchange/{id}', [SellExchangeController::class, 'createExchange'])->name('sell-exchange.create-exchange');
    ...
    Route::get('add-warranti/service', [WarrantyController::class, 'AddwarrantyService'])->name('add.warranty.service');
    Route::post('add-warranti/service/post', [WarrantyController::class, 'AddwarrantyServicePost'])->name('add.warranty.service.POST');
    
    Route::get('list-warranti/service', [WarrantyController::class, 'ListWarrantyService']);
    Route::post('warrnty/get_products', [WarrantyController::class, 'GetWarranty'])->name('GetWarranty');
    Route::get('delivery-warranti/service', [WarrantyController::class, 'DeliverywarrantyService'])->name('delivery.warranty.service');
    // Route::post('replace-warranti/service/post', [WarrantyController::class, 'ReplacewarrantyServicePost'])->name('replace.warranty.service.post');
    Route::post('delivery-warranti/service/post', [WarrantyController::class, 'DeliverywarrantyServicePost'])->name('delivery.warranty.service.post');
    Route::post('warrnty/get_service', [WarrantyController::class, 'GetDelevaryWarranty'])->name('GetDelevaryWarranty');
    
    
    Route::get('print/warranty-recived/invoice/{id}', [WarrantyController::class, 'getRecivedInvoice'])->name('warranty.RecivedprintInvoice');
    Route::get('print/warranty-delevary/invoice/{id}', [WarrantyController::class, 'getDelevaryInvoice'])->name('warranty.DelevaryprintInvoice');
    
    Route::get('warranty-edit/{id}', [WarrantyController::class, 'WarrantyEdit'])->name('warranty.edit');
    Route::post('warranty-edit/post', [WarrantyController::class, 'WarrantyEditPost'])->name('warranty.edit.post');
    Route::delete('warranty-delete/{id}', [WarrantyController::class, 'WarrantyDelete'])->name('warranty.delete');
   



    // For Serial
    Route::post('serial/check_serial', [WarrantyController::class, 'CheckSerial'])->name('checkserial');
    // For Serial
